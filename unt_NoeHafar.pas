...
begin
  ...
  begin
    MessageBox(Handle,'«ÿ·«⁄«  ‰Ê⁄ Õ›«—Ì »—«Ì ‘„«—Â œ—ŒÊ«”  ﬁ»·« Ê«—œ ‘œÂ «” ',' ÊÃÂ !',MB_OK+MB_ICONEXCLAMATION);
    Exit;
  end;}

/////////////////////////////////////////////
  if(cmb_nahve_pardakht.Text='‰ﬁœÌ')then
  begin
    {if(trim(edt_fishvarizi.Text)='')then
    begin
      MessageBox(Handle,'‘„«—Â ›Ì‘ ‰ﬁœÌ —« Ê«—œ ‰„«ÌÌœ',' ÊÃÂ !',MB_OK+MB_ICONEXCLAMATION);
  ...
  begin
      MessageBox(Handle,'‘„«—Â „ÃÊ“ Õ›«—Ì —« Ê«—œ ‰„«ÌÌœ',' ÊÃÂ !',MB_OK+MB_ICONEXCLAMATION);
...
//////////////////////////////////////////////
  ...
  begin
    ...
    begin
      MessageBox(Handle,'‘„«—Â „ÃÊ“ Õ›«—Ì »—«Ì ‘„«—Â œ—ŒÊ«”  ﬁ»·« Ê«—œ ‘œÂ «” ',' ÊÃÂ !',MB_OK+MB_ICONEXCLAMATION);
      Exit;
    end;
  end;
                                          //
  ...
  begin
    ...
    //clear_form;
    MessageBox(Handle,'«ÿ·«⁄«  ÊÌ—«Ì‘ ‘œ.',' ÊÃÂ !',MB_OK+MB_ICONINFORMATION);
  end
  else
      MessageBox(Handle,'„‘Œ’«  ÿÊ· Ê ⁄—÷ Õ›«—Ì »«Ìœ »—«Ì Â„Â ê“Ì‰Â Â«Ì «‰ Œ«»Ì Ê«—œ ‘Ê‰œ',' ÊÃÂ !',MB_OK+MB_ICONEXCLAMATION);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      cmb_nahve_pardakht.ItemIndex:=cmb_nahve_pardakht.Items.IndexOf('‰ﬁœÌ');

      if(cmb_nahve_pardakht.Text='Õ”«» ›Ì„«»Ì‰')then
    ...
    begin
      cmb_nahve_pardakht.ItemIndex:=cmb_nahve_pardakht.Items.IndexOf('Õ”«» ›Ì„«»Ì‰');
...
//////////////////////////////////////////////
  ...
  maduDB.ADOQuery_khesarat.ExecSQL;}
    clear_form;
    MessageBox(Handle,'«ÿ·«⁄«  –ŒÌ—Â ‘œ.',' ÊÃÂ !',MB_OK+MB_ICONINFORMATION);
  end
  else
      MessageBox(Handle,'„‘Œ’«  ÿÊ· Ê ⁄—÷ Õ›«—Ì »«Ìœ »—«Ì Â„Â ê“Ì‰Â Â«Ì «‰ Œ«»Ì Ê«—œ ‘Ê‰œ',' ÊÃÂ !',MB_OK+MB_ICONEXCLAMATION);
end;
...
begin
  if(cmb_sherkathafar.Text='„ ›—ﬁÂ')then
     cmb_nahve_pardakht.ItemIndex:=cmb_nahve_pardakht.Items.IndexOf('‰ﬁœÌ');
