...
begin
  ...
  if (ch_zayeat.Checked) then
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+'Nezarat_Zayeat='+QuotedStr('«‰Ã«„ ‘œÂ')
  else
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+'Nezarat_Zayeat='+QuotedStr('«‰Ã«„ ‰‘œÂ');


  if (ch_payan_hafari.Checked) then
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+',Nezarat_Payane_Hafari='+QuotedStr('«‰Ã«„ ‘œÂ')
  else
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+',Nezarat_Payane_Hafari='+QuotedStr('«‰Ã«„ ‰‘œÂ');


  if (ch_makhlot.Checked) then
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+',Nezarat_Makhlote_Rizi='+QuotedStr('«‰Ã«„ ‘œÂ')
  else
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+',Nezarat_Makhlote_Rizi='+QuotedStr('«‰Ã«„ ‰‘œÂ');


  if (ch_ghargab.Checked) then
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+',Nezarat_Ghargh_Abi='+QuotedStr('«‰Ã«„ ‘œÂ')
  else
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+',Nezarat_Ghargh_Abi='+QuotedStr('«‰Ã«„ ‰‘œÂ');


  if (ch_tarakom.Checked) then
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+',Nezarat_Tarakom_Kamiat='+QuotedStr('«‰Ã«„ ‘œÂ')
  else
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+',Nezarat_Tarakom_Kamiat='+QuotedStr('«‰Ã«„ ‰‘œÂ');


  if (ch_ghir.Checked) then
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+',Nezarat_Ghir_Pashi='+QuotedStr('«‰Ã«„ ‘œÂ')
  else
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+',Nezarat_Ghir_Pashi='+QuotedStr('«‰Ã«„ ‰‘œÂ');


  if (ch_asfalt.Checked) then
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+',Nezarat_Asfalt='+QuotedStr('«‰Ã«„ ‘œÂ')
  else
    maduDB.ADOQuery_nezarat2.SQL.Text:=maduDB.ADOQuery_nezarat2.SQL.Text+',Nezarat_Asfalt='+QuotedStr('«‰Ã«„ ‰‘œÂ');
...
begin
    if (maduDB.ADOQuery_nezaratNezarat_Zayeat.AsString='«‰Ã«„ ‘œÂ') then
      frm_nezart.ch_zayeat.Checked:=true
    else
      frm_nezart.ch_zayeat.Checked:=false;

    if (maduDB.ADOQuery_nezaratNezarat_Payane_Hafari.AsString='«‰Ã«„ ‘œÂ') then
      frm_nezart.ch_payan_hafari.Checked:=true
    else
      frm_nezart.ch_payan_hafari.Checked:=false;

    if (maduDB.ADOQuery_nezaratNezarat_Makhlote_Rizi.AsString='«‰Ã«„ ‘œÂ') then
      frm_nezart.ch_makhlot.Checked:=true
    else
      frm_nezart.ch_makhlot.Checked:=false;


    if (maduDB.ADOQuery_nezaratNezarat_Ghargh_Abi.AsString='«‰Ã«„ ‘œÂ') then
      frm_nezart.ch_ghargab.Checked:=true
    else
      frm_nezart.ch_ghargab.Checked:=false;

    if (maduDB.ADOQuery_nezaratNezarat_Tarakom_Kamiat.AsString='«‰Ã«„ ‘œÂ') then
      frm_nezart.ch_tarakom.Checked:=true
    else
      frm_nezart.ch_tarakom.Checked:=false;

    if (maduDB.ADOQuery_nezaratNezarat_Ghir_Pashi.AsString='«‰Ã«„ ‘œÂ') then
      frm_nezart.ch_ghir.Checked:=true
    else
      frm_nezart.ch_ghir.Checked:=false;

    if (maduDB.ADOQuery_nezaratNezarat_Asfalt.AsString='«‰Ã«„ ‘œÂ') then
